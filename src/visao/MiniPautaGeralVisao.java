...
//    {
//        return trimestreDao.getIdByDescricao( cmbTrimestre.getSelectedItem().toString() );
//    }
    private void procedimento_visualizar()
    {
        List<MiniPautaUtil> list_mini_pauta = new ArrayList<>();
        List<Nota> list_nota = new ArrayList<>();
        MiniPautaUtil object = null;
        double mac = 0, cpp = 0;

        /*1. busca todos alunos de uma determinada turma*/
 /*2. para cada estudante buscar todas as notas da disciplina seleccionada */
 /*3. para cada nota retirar o MAC e o CPP e adiona-lo na lista do objecto criado 'MiniPautaUtil'*/
 /*4. retornar a lista do objecto criado '*/
        List<Estudante> list_estudantes = confirmacaoMatriculaDao.buscaTodosEstudanteConfirmadosByIdTurma( getIdDTurma() );
        Integer idDiciplina = getIdDisiciplina();
        double cap, cpe;
        for ( Estudante estudante : list_estudantes )
        {
            object = new MiniPautaUtil();
            object.setNome_completo( estudante.getNomeCompleto() );
            object.setSexo( estudante.getFkSexo().getDesignacao().substring( 0 ).toUpperCase() );

            list_nota = notaDao.getAllNotaEstudanteByIdDiciplinaAndAnoLectivoAndIdEstudante(
                    getIdDisiciplina(),
                    getIdAno(), estudante.getPkEstudante() );

            if ( list_nota != null )
            {
                for ( Nota nota : list_nota )
                {
                    int tipo_nota = nota.getPkNota();
                    int trimestre = nota.getFkTrimestre().getPkSemestre();
                    ...
                    switch ( trimestre )
                    {
                        case PRIMEIRO_TRIMESTRE:
                        {
                            ...
                            {
                                case MAC:
                                    object.setMac_1( nota.getValor() );
                                    break;
                                case CPP:
                                    object.setCpp_1( nota.getValor() );
                                    break;
                                case CPE_CE:
                                    object.setCpe_ce( nota.getValor() );
                                    break;
                            }
                        ...
                        case SEGUNDO_TRIMESTRE:
                            ...
                            {
                                case MAC:
                                    object.setMac_2( nota.getValor() );
                                    break;
                                case CPP:
                                    object.setCpp_2( nota.getValor() );
                                    break;
                                case CPE_CE:
                                    object.setCpe_ce( nota.getValor() );
                                    break;
                        ...
                        case TERCEIRO_TRIMESTRE:
                            ...
                            {
                                case MAC:
                                    object.setMac_3( nota.getValor() );
                                    break;
                                case CPP:
                                    object.setCpp_3( nota.getValor() );
                                    break;
                                case CPE_CE:
                                    object.setCpe_ce( nota.getValor() );
                                    break;
            ...
            cap = ( ( object.getMac_1() + object.getCpp_1() + object.getMac_2() + object.getCpp_2() + object.getMac_3() + object.getCpp_3() ) / 6 );
            cap = ( cap * 0.4 );
            System.out.println( "MAC 1: " + object.getMac_1() );
            System.out.println( "CPP 1: " + object.getCpp_1() );
            System.out.println( "MAC 2: " + object.getMac_2() );
            System.out.println( "CPP 2: " + object.getCpp_2() );
            System.out.println( "MAC 3: " + object.getMac_3() );
            System.out.println( "CPP 3: " + object.getCpp_3() );

            System.out.println( "CAP: " + cap );
            object.setCap( cap );
            list_mini_pauta.add( object );

        }

        String disicplina = disciplinaDao.findDisciplina( getIdDisiciplina() ).getDesignacao();
        MiniPautaREPORT miniPautaREPORT = new MiniPautaREPORT( list_mini_pauta, turmaDao.findTurma( getIdDTurma() ), disicplina );
