...
//    private EncarregadoDao  encarregadoDao = new EncarregadoDao(emf);
    ...
    {
        adicionar_tabela(  paisDao.buscaTodasPaiss());
    }
    public void salvar()
    {
        ...
        if(!vazios_campos() )
        {
                if( !paisDao.exist_pais(txtDesignacao.getText() ) )
                {
                        try {
                                    pais = new Pais();
                                    setDadosUnidade();
                            ...
                            JOptionPane.showMessageDialog(null, "Erro ao cadastrar o pais ", "ERRO", JOptionPane.ERROR_MESSAGE);
                        }

                }else  JOptionPane.showMessageDialog(null, "Esta pais já existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digite o pais ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    private boolean vazios_campos()
    {
           ...
           if(   txtDesignacao.getText().equals("") )
           {
               ...
               JOptionPane.showMessageDialog(null, "Pf Digite o pais", "AVISO", JOptionPane.WARNING_MESSAGE);
               return true;
           }
...
//           }
    ...
    public void setDadosUnidade(){
                pais.setDesignacao(txtDesignacao.getText().toUpperCase() );
...
// 
    public void alterar()
    {
       ...
       {
                try {
                            pais = paisDao.findPais(this.cod_unidade );
                            setDadosUnidade();
                            paisDao.edit(pais);
                            actualizar();
                            limpar();
                    ...
                    JOptionPane.showMessageDialog(null, "Erro ao alterar o pais ", "ERRO", JOptionPane.ERROR_MESSAGE);
                }
       }else JOptionPane.showMessageDialog(null, "Pf. selecione o pais");
    ...
    private void initComponents() {
        ...
        jLabel19.setText("CADASTRO DE PAÍSES");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaisVisao(1).setVisible(true);
            }
        });
    }
...
//    }
    ...
    private void adicionar_tabela( List<Pais> pais)
    {
            ...
            for (int i = 0; i < pais.size(); i++) 
            {
               ...
               pais.get(i).getPkPais(),
               pais.get(i).getDesignacao(),
               //pais.get(i).getAbreviatura()
    ...
    private void eliminar()
     {
         try {
              paisDao.destroy(this.cod_unidade );
                actualizar();
                limpar();
