...
public class MunicipioVisao extends javax.swing.JFrame {
    ...
    public MunicipioVisao(int id_user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("         FORMULÁRIO DE MUNICÍPIOS");
        ...
        jPanel4.add(txt_municipio, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 90, 260, -1));
        ...
        jPanel4.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 50, 20));
        ...
        jPanel4.add(cmb_provincia, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, 260, -1));
        ...
        jLabel18.setText("Província:");
        jPanel4.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 50, 20));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                " Nº de ordem", "País", "Provincia", "Municipio"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MunicipioVisao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MunicipioVisao(1).setVisible(true);
            }
        });
    }
...
//    }
    ...
    {
//        adicionar_tabela(  municipioDao.buscaTodasMunicipios());
    }
    ...
    private void procedimento_eliminar()
     {
         ...
         if (this.cod_provincia!=0)
         {
                ...
                int opcao = JOptionPane.showConfirmDialog(null, "Tens a certeza que pretendes eliminar essa provincia do estudante : " +txt_municipio.getText());
                ...
                if ( opcao == JOptionPane.YES_OPTION) {
                     ...
                     JOptionPane.showMessageDialog(null, "Municipio não eliminado", "INFO", JOptionPane.INFORMATION_MESSAGE);
                }
 ...
 private void eliminar()
     {
         try {
               municipioDao.destroy(this.cod_provincia);
                actualizar();
               limpar_campos();
               JOptionPane.showMessageDialog(null, "Município eliminado com sucesso!...");
               
         } catch (Exception e) {
             JOptionPane.showMessageDialog(null, "Erro ao eliminar o Município", "ERRO", JOptionPane.ERROR_MESSAGE);
         }
    ...
    
               {
                     ...
                     //if(  !provinciaDao.exist_provincia( txt_provincia )   ){
                                 try {
                                    ...
                                    setSubProvincia();
                                    this.municipioDao.create(this.municipio);
...
//                     }else JOptionPane.showMessageDialog(null, "Este provincia ja se encontra cadastrado no banco de dados","ERRO", JOptionPane.ERROR_MESSAGE);
    ...
    {                
         cmb_provincia.setModel( new DefaultComboBoxModel(   paisDao.buscaTodos ()));
    ...
    public void setDadosProvincia(){      
        this.municipio.setDesignacao(txt_municipio.getText().toUpperCase());
    ...
    {    
         return String.valueOf(cmb_provincia.getSelectedItem());    
    } 
