 ...
 * @author Nécia Caculo
 */
public class MesVisao extends javax.swing.JFrame {
...
//    private EncarregadoDao  encarregadoDao = new EncarregadoDao(emf);
    ...
    {
        adicionar_tabela(  mesDao.buscaTodasMess());
    }
    public void salvar()
    {
        ...
        if(!vazios_campos() )
        {
                if( !mesDao.exist_mes(txtDesignacao.getText() ) )
                {
                        try {
                                    mes = new Mes();
                                    setDadosUnidade();
                            ...
                            JOptionPane.showMessageDialog(null, "Erro ao cadastrar o mes ", "ERRO", JOptionPane.ERROR_MESSAGE);
                        }

                }else  JOptionPane.showMessageDialog(null, "Esta mes já existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digite o mes ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    private boolean vazios_campos()
    {
           ...
           if(   txtDesignacao.getText().equals("") )
           {
               ...
               JOptionPane.showMessageDialog(null, "Pf Digite o mes", "AVISO", JOptionPane.WARNING_MESSAGE);
               return true;
           }
//           else if( txtDesignacao.getText().equals("") )
//           {
//               txtAbreviatura.requestFocus();
//               JOptionPane.showMessageDialog(null, "Pf Digite a abreviatura da mes", "Necia", JOptionPane.WARNING_MESSAGE);
//               return true;
//           }
           else return false;
    ...
    public void setDadosUnidade(){
                mes.setDesignacao(txtDesignacao.getText().toUpperCase() );
                //mes.setAbreviatura( txtAbreviatura.getText().toUpperCase() );
    }
...
// 
    public void alterar()
    {
       ...
       {
                try {
                            mes = mesDao.findMes(this.cod_unidade );
                            setDadosUnidade();
                            mesDao.edit(mes);
                            actualizar();
                            limpar();
                    ...
                    JOptionPane.showMessageDialog(null, "Erro ao alterar o mes ", "ERRO", JOptionPane.ERROR_MESSAGE);
                }
       }else JOptionPane.showMessageDialog(null, "Pf. selecione o mes");
    ...
    private void initComponents() {
        ...
        jLabel19.setText("CADASTRO DE MESES");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MesVisao(1).setVisible(true);
            }
        });
    }
...
//    }
    ...
    private void adicionar_tabela( List<Mes> mes)
    {
            ...
            for (int i = 0; i < mes.size(); i++) 
            {
               ...
               mes.get(i).getPkMes(),
               mes.get(i).getDesignacao(),
               //mes.get(i).getAbreviatura()
    ...
    private void eliminar()
     {
         try {
              mesDao.destroy(this.cod_unidade );
                actualizar();
                limpar();
