 ...
 * @author Nécia Caculo
 */
public class ClasseVisao extends javax.swing.JFrame {
...
//    private EncarregadoDao  encarregadoDao = new EncarregadoDao(emf);
    ...
    {
        adicionar_tabela(  classeDao.buscaTodasClasses());
    }
    public void salvar()
    {
        ...
        if(!vazios_campos() )
        {
                if( !classeDao.exist_classe(txtDesignacao.getText() ) )
                {
                        try {
                                    classe = new Classe();
                                    setDadosUnidade();
                            ...
                            JOptionPane.showMessageDialog(null, "Erro ao cadastrar o classe ", "ERRO", JOptionPane.ERROR_MESSAGE);
                        }

                }else  JOptionPane.showMessageDialog(null, "Esta classe já existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digite o classe ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    private boolean vazios_campos()
    {
           ...
           if(   txtDesignacao.getText().equals("") )
           {
               ...
               JOptionPane.showMessageDialog(null, "Pf Digite o classe", "AVISO", JOptionPane.WARNING_MESSAGE);
               return true;
           }
...
//           }
    ...
    public void setDadosUnidade(){
                classe.setDesignacao(txtDesignacao.getText().toUpperCase() );
                //classe.setAbreviatura( txtAbreviatura.getText().toUpperCase() );
    }
...
// 
    public void alterar()
    {
       ...
       {
                try {
                            classe = classeDao.findClasse(this.cod_unidade );
                            setDadosUnidade();
                            classeDao.edit(classe);
                            actualizar();
                            limpar();
                            JOptionPane.showMessageDialog(null, "Dados alterados com sucesso!...");  
                            
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(null, "Erro ao alterar o classe ", "ERRO", JOptionPane.ERROR_MESSAGE);
                }
       }else JOptionPane.showMessageDialog(null, "Pf. selecione o classe");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClasseVisao(1).setVisible(true);
            }
        });
    }
...
//    }
    ...
    private void adicionar_tabela( List<Classe> classe)
    {
            ...
            for (int i = 0; i < classe.size(); i++) 
            {
               ...
               classe.get(i).getPkClasse(),
               classe.get(i).getDesignacao(),
               //classe.get(i).getAbreviatura()
    ...
    private void eliminar()
     {
         try {
              classeDao.destroy(this.cod_unidade );
                actualizar();
                limpar();
               JOptionPane.showMessageDialog(null, "Classe eliminada com sucesso!...");
               
         } catch (Exception e) {
             JOptionPane.showMessageDialog(null, "Erro ao eliminar a Classe", "ERRO", JOptionPane.ERROR_MESSAGE);
         }
