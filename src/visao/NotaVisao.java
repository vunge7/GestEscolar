...
public class NotaVisao extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jPanel4.add(txt_nota, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 30, 160, -1));
        ...
        jPanel4.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 50, 20));
        ...
        jPanel4.add(cmb_semestre, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 162, -1));

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel17.setText("Trimestre:");
        jPanel4.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 70, 20));
        ...
        jListTurma.setModel(new javax.swing.AbstractListModel<String>()
        {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jListTurma.addMouseListener(new java.awt.event.MouseAdapter()
        {
            public void mouseClicked(java.awt.event.MouseEvent evt)
            {
                jListTurmaMouseClicked(evt);
            }
        });
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(cmb_anoLectivo, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                            .addContainerGap()
                            .addComponent(cmbCurso, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                            .addGap(4, 4, 4)
                            .addComponent(jLabel7)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(cmbClasse, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                " Nº Estudante", "Nome", "Nota", "Semestre", "Disciplina", "Avaliação", "Data Prova"
            }
        )
        {
    ...
    private void jListTurmaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jListTurmaMouseClicked
        // TODO add your handling code here:

        adicionar_estudantes_jList( confirmacaoMatriculaDao.getAllEstudantesByTurma( getIdTurma() ) );
    }//GEN-LAST:event_jListTurmaMouseClicked
...
//    }
    ...
    private void adicionar_turmas_jList()
    {
        ...
        try
        {
            List<Turma> list = turmaDao.getAllTurmaByClasseAnoCurso( getIdClasse(), getIdAno(), getIdCurso() );
            for ( int i = 0; i < list.size(); i++ )
            {
    ...
    {
        adicionar_tabela( notaDao.buscaTodasNotas() );
    }
    ...
    private void eliminar()
    {
        try
        {
            turmaDao.destroy( this.cod_nota );
            actualizar();
            limpar_campos();
...
//                     }else JOptionPane.showMessageDialog(null, "Este nota ja se encontra cadastrado no banco de dados","ERRO", JOptionPane.ERROR_MESSAGE);
    ...
    private void setCampos()
    {
        ...
        cmb_disciplina.setModel( new DefaultComboBoxModel( disciplinaDao.buscaTodos() ) );
    ...
    public void setDadosNota()
    {
        ...
        this.nota.setFkAnoLectivo( anoLectivoDao.findAnoLectivo( anoLectivoDao.getIdByDescricao( getDescricaoAno() ) ) );
...
//                    limpar_campos();
    ...
    private String getIdEstudante()
    {
        return String.valueOf( estudanteDao.getEstudanteByNome( jList1.getSelectedValue() ).getPkEstudante() );
    }
    ...
    {
        return anoLectivoDao.getAnoLectivoByDesignacao( cmb_anoLectivo.getSelectedItem().toString() ).getPkAnoLectivo();
    }
...
//    }
    private void adicionar_tabela( List<Nota> nota )
    {
        ...
        for ( int i = 0; i < nota.size(); i++ )
        {
            modelo.addRow( new Object[]
            {
                nota.get( i ).getFkEstudante().getPkEstudante(),
                nota.get( i ).getFkEstudante().getNomeCompleto(),
                nota.get( i ).getValor(),
