 ...
 * @author Nécia Caculo
 */
public class DisciplinaVisao extends javax.swing.JFrame {
...
//    private EncarregadoDao  encarregadoDao = new EncarregadoDao(emf);
    ...
    public DisciplinaVisao(int idUser) {
    ...
    {
        adicionar_tabela(  disciplinaDao.buscaTodasDisciplinas());
    }
    public void salvar()
    {
        ...
        if(!vazios_campos() )
        {
                if( !disciplinaDao.exist_disciplina(txtDesignacao.getText() ) )
                {
                        try {
                            ...
                            JOptionPane.showMessageDialog(null, "Erro ao cadastrar o disciplina ", "ERRO", JOptionPane.ERROR_MESSAGE);
                        }

                }else  JOptionPane.showMessageDialog(null, "Esta disciplina já existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digite o disciplina ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    private boolean vazios_campos()
    {
           ...
           if(   txtDesignacao.getText().equals("") )
           {
               ...
               JOptionPane.showMessageDialog(null, "Pf Digite o disciplina", "AVISO", JOptionPane.WARNING_MESSAGE);
               return true;
           }
...
//           }
    ...
    public void setDadosUnidade(){
                disciplina.setDesignacao(txtDesignacao.getText().toUpperCase() );
                //disciplina.setAbreviatura( txtAbreviatura.getText().toUpperCase() );
    }
...
// 
    public void alterar()
    {
       ...
       {
                try {
                            disciplina = disciplinaDao.findDisciplina(this.cod_unidade );
                            setDadosUnidade();
                    ...
                    JOptionPane.showMessageDialog(null, "Erro ao alterar o disciplina ", "ERRO", JOptionPane.ERROR_MESSAGE);
                }
       }else JOptionPane.showMessageDialog(null, "Pf. selecione o disciplina");
    ...
    private void initComponents() {
        ...
        jLabel19.setText("CADASTRO DE DISCIPLINAS");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisciplinaVisao(1).setVisible(true);
            }
        });
    }
...
//    }
    ...
    private void adicionar_tabela( List<Disciplina> disciplina)
    {
            ...
            for (int i = 0; i < disciplina.size(); i++) 
            {
               ...
               disciplina.get(i).getPkDisciplina(),
               disciplina.get(i).getDesignacao(),
               //disciplina.get(i).getAbreviatura()
    ...
    private void eliminar()
     {
         try {
              disciplinaDao.destroy(this.cod_unidade );
                actualizar();
                limpar();
