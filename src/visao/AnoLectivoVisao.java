 ...
 * @author Nécia Caculo
 */
public class AnoLectivoVisao extends javax.swing.JFrame {
...
//    private EncarregadoDao  encarregadoDao = new EncarregadoDao(emf);
    private AnoLectivo ano;
    private AnoLectivoDao anoDao = new AnoLectivoDao(emf);
    private int cod_unidade = 0;
     private  int id_user = 0;
    
    public AnoLectivoVisao(int id_user) {
    ...
    {
        adicionar_tabela(  anoDao.buscaTodasAnoLectivos());
    }
    public void salvar()
    {
        ...
        if(!vazios_campos() )
        {
                if( !anoDao.exist_ano(txtDesignacao.getText() ) )
                {
                        try {
                                    ano = new AnoLectivo();
                                    setDadosUnidade();
                            ...
                            JOptionPane.showMessageDialog(null, "Erro ao cadastrar o ano ", "ERRO", JOptionPane.ERROR_MESSAGE);
                        }

                }else  JOptionPane.showMessageDialog(null, "Esta ano já existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digite o ano ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    private boolean vazios_campos()
    {
           ...
           if(   txtDesignacao.getText().equals("") )
           {
               ...
               JOptionPane.showMessageDialog(null, "Pf Digite o ano", "AVISO", JOptionPane.WARNING_MESSAGE);
               return true;
           }
//           else if( txtDesignacao.getText().equals("") )
//           {
//               txtAbreviatura.requestFocus();
//               JOptionPane.showMessageDialog(null, "Pf Digite a abreviatura da ano", "Necia", JOptionPane.WARNING_MESSAGE);
//               return true;
//           }
           else return false;
    ...
    public void setDadosUnidade(){
        ...
        ano.setDesignacao(txtDesignacao.getText().toUpperCase());
                
                //ano.setAbreviatura( txtAbreviatura.getText().toUpperCase() );
    }
...
// 
    public void alterar()
    {
       ...
       {
                try {
                            ano = anoDao.findAnoLectivo(this.cod_unidade );
                            setDadosUnidade();
                            anoDao.edit(ano);
                            actualizar();
                            limpar();
                    ...
                    JOptionPane.showMessageDialog(null, "Erro ao alterar o ano ", "ERRO", JOptionPane.ERROR_MESSAGE);
                }
       }else JOptionPane.showMessageDialog(null, "Pf. selecione o ano");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nova Ano Lectivo:");
        ...
        jLabel19.setText("CADASTRO DE CLASSES");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnoLectivoVisao(1).setVisible(true);
            }
        });
    }
...
//    }
    ...
    private void adicionar_tabela( List<AnoLectivo> ano)
    {
            ...
            for (int i = 0; i < ano.size(); i++) 
            {
               ...
               ano.get(i).getPkAnoLectivo(),
               ano.get(i).getDesignacao(),
               //ano.get(i).getAbreviatura()
    ...
    private void eliminar()
     {
         try {
              anoDao.destroy(this.cod_unidade );
                actualizar();
                limpar();
