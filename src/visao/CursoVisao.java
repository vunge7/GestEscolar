 ...
 * @author Nécia Caculo
 */
public class CursoVisao extends javax.swing.JFrame {
...
//    private EncarregadoDao  encarregadoDao = new EncarregadoDao(emf);
    ...
    {
        adicionar_tabela(  cursoDao.buscaTodasCursos());
    }
    public void salvar()
    {
        ...
        if(!vazios_campos() )
        {
                if( !cursoDao.exist_curso(txtDesignacao.getText() ) )
                {
                        try {
                                    curso = new Curso();
                                    setDadosUnidade();
                            ...
                            JOptionPane.showMessageDialog(null, "Erro ao cadastrar o curso ", "ERRO", JOptionPane.ERROR_MESSAGE);
                        }

                }else  JOptionPane.showMessageDialog(null, "Esta curso já existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digite o curso ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    private boolean vazios_campos()
    {
           ...
           if(   txtDesignacao.getText().equals("") )
           {
               ...
               JOptionPane.showMessageDialog(null, "Pf Digite o curso", "AVISO", JOptionPane.WARNING_MESSAGE);
               return true;
           }
...
//           }
    ...
    public void setDadosUnidade(){
                curso.setDesignacao(txtDesignacao.getText().toUpperCase() );
                //curso.setAbreviatura( txtAbreviatura.getText().toUpperCase() );
    }
...
// 
    public void alterar()
    {
       ...
       {
                try {
                            curso = cursoDao.findCurso(this.cod_unidade );
                            setDadosUnidade();
                            cursoDao.edit(curso);
                            actualizar();
                            limpar();
       ...
       }else JOptionPane.showMessageDialog(null, "Pf. selecione o curso");
    ...
    private void initComponents() {
        ...
        jLabel19.setText("CADASTRO DE CURSOS");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CursoVisao(1).setVisible(true);
            }
        });
    }
...
//    }
    ...
    private void adicionar_tabela( List<Curso> curso)
    {
            ...
            for (int i = 0; i < curso.size(); i++) 
            {
               ...
               curso.get(i).getPkCurso(),
               curso.get(i).getDesignacao(),
    ...
    private void eliminar()
     {
         try {
              cursoDao.destroy(this.cod_unidade );
                actualizar();
                limpar();
