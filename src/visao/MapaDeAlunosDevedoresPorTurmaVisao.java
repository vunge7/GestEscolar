...
import entity.Turma;
import ireport.MapaAunosDevedoresREPORT;
 ...
 */
public class MapaDeAlunosDevedoresPorTurmaVisao extends javax.swing.JFrame
{
    ...
    private final MesDao mesDao = new MesDao( emf );
    private final PrecoPropinaDao precoPropinaDao = new PrecoPropinaDao( emf );
    
    public MapaDeAlunosDevedoresPorTurmaVisao()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        cmbMes.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cmbMes, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel10.setText("MAPA DE ALUNOS DEVEDORES POR TURMA");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLabel10, javax.swing.GroupLayout.DEFAULT_SIZE, 620, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(6, 6, 6)
    ...
    {//GEN-HEADEREND:event_cmbMesMouseClicked
        // TODO add your handling code here:
    ...
    public static void main( String args[] )
    {
        ...
        {
            java.util.logging.Logger.getLogger( MapaDeAlunosDevedoresPorTurmaVisao.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        }
        ...
        java.awt.EventQueue.invokeLater( new Runnable()
        {
            public void run()
            {
                new MapaDeAlunosDevedoresPorTurmaVisao().setVisible( true );
            }
        } );
    }
    ...
    {
        return mesDao.getPkByDescricao( cmbMes.getSelectedItem().toString() );
    }
    ...
    private void procedimento_vusualizar()
    {
        ...
        for ( Estudante estudante : lista_estudante )
        {
            ...
            if ( ultimo_mes_pago < getIdMes() )
            {
                list_mapa.add( getObjecto( estudante, preco_propina, ultimo_mes_pago ) );
            }
        }
        
        MapaAunosDevedoresREPORT mapaPropinasREPORT = new MapaAunosDevedoresREPORT( list_mapa, turma );
    ...
    private MapaApontamentoPropinaUtil getObjecto( Estudante estudante, double preco, int ultimo_mes_pago )
    {
        ...
        object.setDescricao( estudante.getFkEncarregado().getTelefone() );
