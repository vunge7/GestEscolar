 ...
 * @author Nécia Caculo
 */
public class TrimestreVisao extends javax.swing.JFrame {
...
//    private EncarregadoDao  encarregadoDao = new EncarregadoDao(emf);
    ...
    public TrimestreVisao(int idUser) {
    ...
    {
        adicionar_tabela(  trimestreDao.buscaTodosTrimestres());
    }
    public void salvar()
    {
        ...
        if(!vazios_campos() )
        {
                if( !trimestreDao.exist_semestre(txtDesignacao.getText() ) )
                {
                        try {
                            ...
                            JOptionPane.showMessageDialog(null, "Erro ao cadastrar o trimestre ", "ERRO", JOptionPane.ERROR_MESSAGE);
                        }

                }else  JOptionPane.showMessageDialog(null, "Esta trimestre já existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digite o trimestre ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    private boolean vazios_campos()
    {
           ...
           if(   txtDesignacao.getText().equals("") )
           {
               ...
               JOptionPane.showMessageDialog(null, "Pf Digite o trimestre", "AVISO", JOptionPane.WARNING_MESSAGE);
               return true;
           }
...
//           }
    ...
    public void setDadosUnidade(){
                trimestre.setDesignacao(txtDesignacao.getText().toUpperCase() );
                //trimestre.setAbreviatura( txtAbreviatura.getText().toUpperCase() );
    }
...
// 
    public void alterar()
    {
       ...
       {
                try {
                            trimestre = trimestreDao.findTrimestre(this.cod_unidade );
                            setDadosUnidade();
                            trimestreDao.edit(trimestre);
                            actualizar();
                            limpar();
                            JOptionPane.showMessageDialog(null, "Dados alterados com sucesso!...");  
                            
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(null, "Erro ao alterar o trimestre ", "ERRO", JOptionPane.ERROR_MESSAGE);
                }
       }else JOptionPane.showMessageDialog(null, "Pf. selecione o trimestre");
    ...
    private void initComponents() {
        ...
        jLabel19.setText("CADASTRO DE SEMESTRE");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrimestreVisao(1).setVisible(true);
            }
        });
    }
...
//    }
    ...
    private void adicionar_tabela( List<Trimestre> trimestre)
    {
            ...
            for (int i = 0; i < trimestre.size(); i++) 
            {
               ...
               trimestre.get(i).getPkSemestre(),
               trimestre.get(i).getDesignacao(),
               //trimestre.get(i).getAbreviatura()
    ...
    private void eliminar()
     {
         try {
              trimestreDao.destroy(this.cod_unidade );
                actualizar();
                limpar();
