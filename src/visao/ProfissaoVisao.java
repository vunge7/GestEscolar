 ...
 * @author Nécia Caculo
 */
public class ProfissaoVisao extends javax.swing.JFrame {
...
//    private EncarregadoDao  encarregadoDao = new EncarregadoDao(emf);
    ...
    public ProfissaoVisao(int idUser) {
    ...
    {
        adicionar_tabela(  profissaoDao.buscaTodasProfissaos());
    }
    public void salvar()
    {
        ...
        if(!vazios_campos() )
        {
                if( !profissaoDao.exist_profissao(txtDesignacao.getText() ) )
                {
                        try {
                            ...
                            JOptionPane.showMessageDialog(null, "Erro ao cadastrar o profissao ", "ERRO", JOptionPane.ERROR_MESSAGE);
                        }

                }else  JOptionPane.showMessageDialog(null, "Esta profissao já existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digite o profissao ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    private boolean vazios_campos()
    {
           ...
           if(   txtDesignacao.getText().equals("") )
           {
               ...
               JOptionPane.showMessageDialog(null, "Pf Digite o profissao", "AVISO", JOptionPane.WARNING_MESSAGE);
               return true;
           }
...
//           }
    ...
    public void setDadosUnidade(){
                profissao.setDesignacao(txtDesignacao.getText().toUpperCase() );
                //profissao.setAbreviatura( txtAbreviatura.getText().toUpperCase() );
    }
...
// 
    public void alterar()
    {
       ...
       {
                try {
                            profissao = profissaoDao.findProfissao(this.cod_unidade );
                            setDadosUnidade();
                            profissaoDao.edit(profissao);
                            actualizar();
                            limpar();
                            JOptionPane.showMessageDialog(null, "Dados alterados com sucesso!...");  
                            
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(null, "Erro ao alterar o profissao ", "ERRO", JOptionPane.ERROR_MESSAGE);
                }
       }else JOptionPane.showMessageDialog(null, "Pf. selecione o profissao");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nova Profissão:");
        ...
        jLabel19.setText("CADASTRO DE PROFISSÕES");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfissaoVisao(1).setVisible(true);
            }
        });
    }
...
//    }
    ...
    private void adicionar_tabela( List<Profissao> profissao)
    {
     
            DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();

            modelo.setRowCount(0);
            for (int i = 0; i < profissao.size(); i++) 
            {
               modelo.addRow(new Object[]{
               profissao.get(i).getPkProfissao(),
               profissao.get(i).getDesignacao(),
               //profissao.get(i).getAbreviatura()
    ...
    private void eliminar()
     {
         try {
              profissaoDao.destroy(this.cod_unidade );
                actualizar();
                limpar();
