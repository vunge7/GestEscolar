 ...
 * @author Nécia Caculo
 */
public class SalaVisao extends javax.swing.JFrame {
...
//    private EncarregadoDao  encarregadoDao = new EncarregadoDao(emf);
    ...
    {
        adicionar_tabela(  salaDao.buscaTodasSalas());
    }
    public void salvar()
    {
        ...
        if(!vazios_campos() )
        {
                if( !salaDao.exist_sala(txtDesignacao.getText() ) )
                {
                        try {
                                    sala = new Sala();
                                    setDadosUnidade();
                            ...
                            JOptionPane.showMessageDialog(null, "Erro ao cadastrar o sala ", "ERRO", JOptionPane.ERROR_MESSAGE);
                        }

                }else  JOptionPane.showMessageDialog(null, "Esta sala já existe ", "AVISO", JOptionPane.WARNING_MESSAGE);
        }else JOptionPane.showMessageDialog(null, "Pf digite o sala ", "AVISO", JOptionPane.WARNING_MESSAGE);
    }
    ...
    private boolean vazios_campos()
    {
           ...
           if(   txtDesignacao.getText().equals("") )
           {
               ...
               JOptionPane.showMessageDialog(null, "Pf Digite o sala", "AVISO", JOptionPane.WARNING_MESSAGE);
               return true;
           }
...
//           }
    ...
    public void setDadosUnidade(){
                sala.setDesignacao(txtDesignacao.getText().toUpperCase() );
                //sala.setAbreviatura( txtAbreviatura.getText().toUpperCase() );
    }
...
// 
    public void alterar()
    {
       ...
       {
                try {
                            sala = salaDao.findSala(this.cod_unidade );
                            setDadosUnidade();
                            salaDao.edit(sala);
                            actualizar();
                            limpar();
                    ...
                    JOptionPane.showMessageDialog(null, "Erro ao alterar o sala ", "ERRO", JOptionPane.ERROR_MESSAGE);
                }
       }else JOptionPane.showMessageDialog(null, "Pf. selecione o sala");
    ...
    private void initComponents() {
        ...
        jLabel19.setText("CADASTRO DE SALAS");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalaVisao(1).setVisible(true);
            }
        });
    }
...
//    }
    ...
    private void adicionar_tabela( List<Sala> sala)
    {
            ...
            for (int i = 0; i < sala.size(); i++) 
            {
               ...
               sala.get(i).getPkSala(),
               sala.get(i).getDesignacao(),
               //sala.get(i).getAbreviatura()
    ...
    private void eliminar()
     {
         try {
              salaDao.destroy(this.cod_unidade );
                actualizar();
                limpar();
